<?php
  ...
  echo "<br> result is: " . substr("hello", 2, 2) . "<br>";
    print_r("<br> position is: " . strpos("hello", 'k') . "<br>");
    print_r("<br> string length is: " . strlen("hello -465") . "<br>");
...
//   echo "<h1>" . isPalindrome("ddd 444 55 9", $strArr) . "</h1>";
...
//    echo calculateAverage($numbers); // Output: 12.5
// echo "<h1>" . calculateAverage($numbers) . "</h1>";
...
// echo "<h1>" . countVowels("abcd") . "</h1>";
// echo countVowels("OpenAI is awesome!"); // Output: 6
...
echo "<h1>" . isPrime(13) . "</h1>";
echo isPrime(16); // Output: false
